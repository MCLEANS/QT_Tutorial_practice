...
public:
    ...
    void setupUi(QMainWindow *MyWindow)
    {
        ...
        pushButtonClosed = new QPushButton(centralwidget);
        pushButtonClosed->setObjectName(QString::fromUtf8("pushButtonClosed"));
        pushButtonClosed->setGeometry(QRect(340, 200, 111, 41));
        label = new QLabel(centralwidget);
        label->setObjectName(QString::fromUtf8("label"));
        label->setGeometry(QRect(330, 270, 141, 31));
    ...
    void retranslateUi(QMainWindow *MyWindow)
    {
        ...
        pushButtonClosed->setText(QApplication::translate("MyWindow", "Click Me", nullptr));
